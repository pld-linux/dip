...
Dip jest narzędziem do dzwonienia za pomocą modemu. Obsługuje
połączenia IP takie jak SLIP czy PPP. Dip obsługuje zarówno połączenia
przychodzące jak i wychodzące, przy czym bezpieczeństwo połączeń
przychodzących opiera się na hasłach. Można wykorzystać dip do
ustawienia połączeń PPP i SLIP, ale nie jest do tego niezbędny. Netcfg
używa dip do ustawienia połączeń SLIP. Należy zainstalować dip jeśli
potrzebuje się narzędzia do obsługi modemowych połączeń IP.
